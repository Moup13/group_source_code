from sqlatchemy import Column, Integer, ForeingKey, VARCHAR ,UniqueConstraint, SMALLINT
...
class MusicalComposition(Base):
    ...
    id = Column(Integer,primary_key=True, autoincrement=True,nullable=False)
    user_id = Column(Integer, ForeingKey(f'{User.__tablename__}.{User.id.name}'),nullable=False)
